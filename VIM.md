...
>
>   > 처음 문제를 풀 때, n=1부터 계산해보면서 피보나치 규칙을 찾아서 문제를 풀었었는데, 다른 접근 방법도 있다는 것도 그때 알게 되어서 2가지 접근 방법을 정리해 보고자 [2 x n 타일링 문제](https://www.acmicpc.net/problem/11726)를 vim으로 코드를 짜게 되었습니다.
